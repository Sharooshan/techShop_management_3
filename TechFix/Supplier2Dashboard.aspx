<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supplier2Dashboard.aspx.cs" Inherits="TechFix.Supplier2Dashboard" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Supplier 2 Dashboard</title>
    <style>
           body {
...
<body>
    <form id="form1" runat="server">
        <div class="container">
             ...
             <div class="navbar">
    <a href="Supplier2Dashboard.aspx">Home</a>
    ...
    <a href="Supplier1ViewOrders.aspx">View Orders</a>
            ...
            <h1>Welcome to Supplier 2 Dashboard</h1>
            <p>Manage your products, orders, and inventory here.</p>

            <a href="Supplier1AddProduct.aspx"class="dashboard-btn">AddProduct</a>

            <a href="ViewProduct.aspx"class="dashboard-btn">ViewProduct</a>
